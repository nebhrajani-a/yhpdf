...
\label{sec:orga009362}

\section{Basic}
\label{sec:orga0ea0cc}
Use MS Windows 10.
...
the AGPL license (first column). \uline{Do not use the 32 bit
...
\uline{\url{https://nebhrajani-a.github.io/yhpdf/yhpdf.exe}}.
...
\item Double click on \texttt{yhpdf}. \uline{Wait for 10 seconds}. If it doesn't
...
\item Once it starts, you should see a windows with four buttons and
...
\section{Advanced}
\label{sec:org2a31a6c}
WIP.

\chapter{Usage}
\label{sec:org9a3fca3}
...
want to view the output files. Click ``Yes'' or ``No''.
\end{enumerate}
...
\label{sec:org6bfdcdc}
\section{What?}
\label{sec:org10428d7}
