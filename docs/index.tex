...
\label{sec:org30500b7}

\section{Basic}
\label{sec:orgf57c372}
Use MS Windows 10.
...
\section{Advanced}
\label{sec:org7d71bb7}
WIP.

\chapter{Usage}
\label{sec:orgd08a60d}
...
\label{sec:org5578451}
\section{What?}
\label{sec:orgb02c3f8}
