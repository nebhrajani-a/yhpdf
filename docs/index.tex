...
\label{sec:org5a41c06}

\section{Basic}
\label{sec:orgcc296e5}
Use MS Windows 10.
...
\section{Advanced}
\label{sec:orgc7a1b31}
WIP.

\chapter{Usage}
\label{sec:orgb08fcd2}
...
\label{sec:orgc3f11e2}
\section{What?}
\label{sec:org5c10e7a}
